...
import { Play, Square, Download, Clock, AlertCircle, CheckCircle2, Search } from 'lucide-react';
    ...
    <div className="flex h-full overflow-hidden">
      ...
      <main className="flex-1 flex flex-col bg-background-dark overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
          <ChartSection title="Bit B0102 (Write Sequence)" type="bit" data={timelineData} />
          <ChartSection title="Analog IN_04 (Read Expect)" type="analog" data={timelineData} />
          
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-surface-dark/20 border border-border-dark rounded-xl p-4">
              <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4">Deviation Monitor</h4>
            ...
            <div className="bg-surface-dark/20 border border-border-dark rounded-xl p-4 flex flex-col">
              <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4">Live Log Stream</h4>
              <div className="flex-1 font-mono text-[11px] space-y-1 overflow-y-auto text-slate-400">
